...
{
    semantic_err++;
    printf(ERROR_TEXT_COLOR "ERROR NO:%d *** semantic error at line %d: ", i, ll);
    switch (i)
    {
    ...
    printf(NORMAL_TEXT_COLOR);
}

void semantic_warning(int i, int ll)
{
    printf(WARNING_TEXT_COLOR "--- warning at line %d:", ll);
    switch (i)
    {
    case 11:
